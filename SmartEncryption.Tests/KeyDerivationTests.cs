...
namespace SmartEncryption.Tests
{
    ...
    {
        [TestMethod]
        public void DeriveKeyStringTest()
        {
            const string PASSWORD = "This is a test key";
            const string SALT = "44071f6d181561670bda728d43fb79b443bb805afdebaf98622b5165e01b15fb";
            const long OUTPUT_LENGTH = 32;

            var hash1 = KeyDerivation.DeriveKey(PASSWORD, Utilities.HexToBinary(SALT));
            var hash2 = KeyDerivation.DeriveKey(PASSWORD, Utilities.HexToBinary(SALT));
